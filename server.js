...
app.get('/gato-brand.css', (req, res) => res.sendFile(path.join(__dirname, 'public', 'gato-brand.css')));
app.get('/gato-brand.js', (req, res) => res.sendFile(path.join(__dirname, 'public', 'gato-brand.js')));
